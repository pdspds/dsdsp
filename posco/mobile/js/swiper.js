      ...
      events: {
        attachEvents: function () {
          ...
          if (ae.touch || (!ae.pointerEvents && !ae.prefixedPointerEvents)) {
            ...
            ((t.simulateTouch && !g.ios && !g.android) ||
              ...
              (r.addEventListener("touchstart", e.onTouchStart, !1),
              f.addEventListener("touchmove", e.onTouchMove, n),
              f.addEventListener("touchend", e.onTouchEnd, !1));
          } else
            r.addEventListener(a.start, e.onTouchStart, !1),
              f.addEventListener(a.move, e.onTouchMove, n),
              f.addEventListener(a.end, e.onTouchEnd, !1);
          (t.preventClicks || t.preventClicksPropagation) &&
            r.addEventListener("touch", e.onClick, !0),
            e.on(
              g.ios || g.android
        ...
        detachEvents: function () {
          ...
          if (ae.touch || (!ae.pointerEvents && !ae.prefixedPointerEvents)) {
            ...
            ((t.simulateTouch && !g.ios && !g.android) ||
              (t.simulateTouch && !ae.touch && g.ios)) &&
              (r.removeEventListener("touchstart", e.onTouchStart, !1),
              f.removeEventListener("touchmove", e.onTouchMove, n),
              f.removeEventListener("touchend", e.onTouchEnd, !1));
          } else
            r.removeEventListener(a.start, e.onTouchStart, !1),
              f.removeEventListener(a.move, e.onTouchMove, n),
              f.removeEventListener(a.end, e.onTouchEnd, !1);
          (t.preventClicks || t.preventClicksPropagation) &&
            r.removeEventListener("touch", e.onClick, !0),
            e.off(
              g.ios || g.android
                ? "resize orientationchange observerUpdate"
                : "resize observerUpdate",
    ...
    A = {
      ...
      init: function () {
        ...
        (i.nextEl || i.prevEl) &&
          ...
          e && 0 < e.length && e.on("touch", a.navigation.onNextClick),
          t && 0 < t.length && t.on("touch", a.navigation.onPrevClick),
      ...
      destroy: function () {
        ...
        a &&
          a.length &&
          (a.off("touch", e.navigation.onNextClick),
          a.removeClass(e.params.navigation.disabledClass)),
          i &&
            i.length &&
            (i.off("touch", e.navigation.onPrevClick),
      ...
      init: function () {
        ...
        if (e.el) {
          ...
          0 !== t.length &&
            ...
            e.clickable &&
              t.on("touch", "." + e.bulletClass, function (e) {
                e.preventDefault();
      ...
      destroy: function () {
        ...
        if (
          ...
          a.removeClass(t.hiddenClass),
            ...
            t.clickable && a.off("touch", "." + t.bulletClass);
        }
      },
    },
    G = {
